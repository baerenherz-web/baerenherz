...
const frontmatter = {
  ...
  "pubDate": "Jan 06 2022",
  "cover": "@assets/aktivitaeten/golf-2022.jpg",
  "coverAlt": "Golf",
...
const url = "src/content/aktivitaeten/ch/charity-golfturnier-2022.mdx";
const file = "D:/Bärenherz/Repository/baerenherz/src/content/aktivitaeten/ch/charity-golfturnier-2022.mdx";
const Content = (props = {}) => MDXContent({
											...props,
											components: { Fragment, ...props.components },
										});
Content[Symbol.for('astro.needsHeadRendering')] = !Boolean(frontmatter.layout);
Content.moduleId = "D:/Bärenherz/Repository/baerenherz/src/content/aktivitaeten/ch/charity-golfturnier-2022.mdx";
