/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, f as renderComponent, F as Fragment, m as maybeRenderHead, $ as $$Image } from '../../renderers.mjs';
import { $ as $$Container, a as $$Link, b as $$Layout } from './404.astro.a3cd5782.mjs';
import { $ as $$Sectionhead } from './about.astro.583b239b.mjs';
import 'preact';
import 'react';
...
const localImage = {"src":"/_astro/baby-2.057ef66f.jpeg","width":2048,"height":1536,"format":"jpg"};
...
const $$Projekte = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`
    ${maybeRenderHead()}<section class="py-10 md:px-14 xl:mx-auto xl:my-6 xl:w-3/4">
      ...
      <!-- Check the time load of the images -->
      <div class="w-10/12">
        <div class="my-8 flex flex-col gap-1 justify-self-center md:flex-row">
          ${renderComponent($$result3, "Image", $$Image, { "src": galleryFlex1, "alt": "hope logo", "class": "md:h-36 md:w-fit lg:h-48" })}
          ${renderComponent($$result3, "Image", $$Image, { "src": galleryFlex2, "alt": "hope logo", "class": "md:h-36 md:w-fit lg:h-48" })}
          ${renderComponent($$result3, "Image", $$Image, { "src": galleryFlex3, "alt": "hope logo", "class": "md:h-36 md:w-fit lg:h-48" })}
          ${renderComponent($$result3, "Image", $$Image, { "src": galleryFlex4, "alt": "hope logo", "class": "md:h-36 md:w-fit lg:h-48" })}
        </div>
      </div>
      ...
      <article class="py-6">
        ...
        <!--   
        <div
          class="my-8 grid grid-rows-2 justify-items-center md:grid-flow-col">
          <Image src={galleryGrid1} alt="hope logo" />
          <Image src={galleryGrid2} alt="hope logo" />
          <Image src={galleryGrid3} alt="hope logo" />
          <Image src={galleryGrid4} alt="hope logo" />
        </div>
       -->
  ...
  ` })}
` })}`;
}, "/home/qwerty/Workspace/Projects/Baerenherz/newWeb/Baerenherz/src/pages/projekte.astro", void 0);

const $$file = "/home/qwerty/Workspace/Projects/Baerenherz/newWeb/Baerenherz/src/pages/projekte.astro";
const $$url = "/projekte";

export { $$Projekte as default, $$file as file, $$url as url };
