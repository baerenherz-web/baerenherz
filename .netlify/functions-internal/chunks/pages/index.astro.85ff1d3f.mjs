...
import { a as $$Link, $ as $$Container, b as $$Layout } from './404.astro.16f1e469.mjs';
import { $ as $$Newsletter } from './about.astro.6fc6a354.mjs';
import { g as getCollection } from './_...slug_.astro.797b8393.mjs';
...
function Carousel() {
  ...
  return /* @__PURE__ */ jsx("div", {
    children: /* @__PURE__ */ jsx(Slider, {
      ...settings,
      children: photos.map((photo) => /* @__PURE__ */ jsxs("div", {
...
const $$Index$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`
    ${maybeRenderHead()}<div class="border-2 border-red-700 p-0">
      ...
      <!-- <Carousel2 client:idle /> -->
      <!-- <CarouselSevelte client:idle /> -->
    </div>
