...
const $$Datenschutz = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Datenschutz;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Datenschutz \u2013 B\xE4renherz e.V." }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<section class="prose mx-auto my-10 max-w-2xl px-4">
    ...
    <p>Zusätzlich oder als Alternative zum Browser-Add-On können Sie das Tracking durch Google Analytics auf unseren Seiten unterbinden, indem Sie diesen <a href="javascript:gaOptout()">Link</a> anklicken. Dabei wird ein Opt-Out-Cookie auf Ihrem Gerät installiert. Damit wird die Erfassung durch Google Analytics für diese Website und für diesen Browser zukünftig verhindert, so lange das Cookie in Ihrem Browser installiert bleibt.</p>
    ...
    <p>Diese Webseite verwendet Google Maps API, um geographische Informationen visuell darzustellen. Bei der Nutzung von Google Maps werden von Google auch Daten über die Nutzung der Kartenfunktionen durch Besucher erhoben, verarbeitet und genutzt. Nähere Informationen über die Datenverarbeitung durch Google können Sie den <a href="https://www.google.com/policies/privacy/">Google-Datenschutzhinweisen</a> entnehmen. Dort können Sie im <a href="https://safety.google/intl/de_ch/privacy/privacy-controls/">Datenschutzcenter</a> auch Ihre persönlichen Datenschutz-Einstellungen verändern.</p>
    ...
    <p>
        Nach eigenen Angaben erhebt Google bei diesem Vorgang keine personenbezogenen Daten. Sollten Sie die Funktion Remarketing von Google dennoch nicht wünschen, können Sie diese grundsätzlich deaktivieren, indem Sie die entsprechenden Einstellungen unter <a href="http://www.google.com/settings/ads">http://www.google.com/settings/ads</a> vornehmen. Alternativ können Sie den Einsatz von Cookies für interessenbezogene Werbung über die Werbenetzwerkinitiative deaktivieren, indem Sie den Anweisungen unter <a href="http://www.networkadvertising.org/managing/opt_out.asp">http://www.networkadvertising.org/managing/opt_out.asp</a> folgen.
    </p>

    <h2>Einsatz von Leadinfo</h2>

    <p>
        Wir nutzen den Lead-Generation-Service von Leadinfo B.V., Rotterdam, Niederlande. Dieser erkennt Besuche von Unternehmen auf unserer Website anhand von IP-Adressen und zeigt uns hierzu öffentlich verfügbare Informationen, wie z.B. Firmennamen oder Adressen. Darüber hinaus setzt Leadinfo zwei First-Party-Cookies zur Auswertung des Nutzerverhaltens auf unserer Website und verarbeitet Domains aus Formulareingaben (z.B. „leadinfo.com“), um IP-Adressen mit Unternehmen zu korrelieren und die Services zu verbessern. Weitere Informationen finden Sie unter <a href="http://www.leadinfo.com">www.leadinfo.com</a>. Auf dieser Seite: <a href="http://www.leadinfo.com/en/opt-out">www.leadinfo.com/en/opt-out</a> haben Sie eine Opt-out Möglichkeit. Im Falle eines Opt-outs werden Ihre Daten von Leadinfo nicht mehr erfasst.
    </p>
    ...
    <p>
        Wenn Sie Fragen zum Datenschutz haben, wenden Sie sich bitte direkt an die für den Datenschutz verantwortliche Person in unserer Organisation, erreichbar unter:
    </p>
...
` })}`;
}, "D:/B\xE4renherz/Repository/baerenherz/src/pages/de/datenschutz.astro", void 0);

const $$file = "D:/Bärenherz/Repository/baerenherz/src/pages/de/datenschutz.astro";
const $$url = "/de/datenschutz";

export { $$Datenschutz as default, $$file as file, $$url as url };
