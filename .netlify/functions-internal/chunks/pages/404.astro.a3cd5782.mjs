  ...
  ${renderComponent($$result, "Dropdown", $$Dropdown$1, { "class": "group" }, { "default": ($$result2) => renderTemplate`
    ...
    lastItem ? "lg:right-0 origin-top-right" : "lg:left-0 origin-top-left"
        ...
        <div class="flex flex-col px-3 lg:rounded-md lg:border lg:bg-white lg:py-2 lg:shadow">
          ${children.map((item) => renderTemplate`<a${addAttribute(item.path, "href")} class="p-2 text-sm text-gray-600 hover:bg-[#dfecf7] hover:text-[#2b2523]">
                ${item.title}
              </a>`)}
        </div>
      </div>
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const menuItems = [
    ...
    { title: "Projekte", path: "/projekte" },
    {
      ...
      children: [
        {
          title: "Alle Aktivit\xE4ten",
          path: "/aktivitaeten/"
        },
        {
          title: "Save the date Charity Sky Tage 2024",
          path: "/aktivitaeten/save-date-sky2024"
        },
        {
          title: "Save the date Charity Golfturnier 2024",
          path: "/aktivitaeten/save-date-golf2024"
        },
        {
    ...
    ${renderComponent($$result2, "Astronav", $$Astronav, {}, { "default": ($$result3) => renderTemplate`
      <div class="flex w-full items-center justify-between lg:w-auto">
        ...
        <div class="block lg:hidden">
          ${renderComponent($$result3, "MenuIcon", $$MenuIcon, { "class": "h-8 w-8 text-[#4b4e52]" })}
        </div>
      </div>
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <head>
    <meta charset="UTF-8">
    <meta name="Bärenherz" content="Verein für humanitäre Hilfe">
