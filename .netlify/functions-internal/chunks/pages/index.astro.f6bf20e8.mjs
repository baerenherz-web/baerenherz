...
import { a as $$Link, $ as $$Container, b as $$Layout } from './404.astro.22081207.mjs';
import { $ as $$Newsletter } from './about.astro.9f9dd22c.mjs';
import { g as getCollection } from './_...slug_.astro.e2038acc.mjs';
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsx("img", {
        ...
        children: [photo.id === "1" && /* @__PURE__ */ jsx("div", {
          ...
          className: "m-20 flex max-w-screen-md flex-col bg-[#f2f8f9] px-4 py-6 md:w-2/6 md:px-6",
          children: [/* @__PURE__ */ jsx("h4", {
            className: "text-2xl tracking-tight",
            children: photo.heading
          }), /* @__PURE__ */ jsx("span", {
            className: "my-4 w-full border-b-2 border-[#033277]"
          }), /* @__PURE__ */ jsx("h2", {
            className: "text-3xl font-bold md:text-4xl md:leading-tight",
...
const $$Index$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`
    ${maybeRenderHead()}<div class="p-0">
      ${renderComponent($$result3, "Carousel", Carousel, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@components/carousel/Carousel.tsx", "client:component-export": "default" })}
    </div>
