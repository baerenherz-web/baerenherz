...
const url = "src/content/news/golf-charity-hope.mdx";
const file = "D:/Bärenherz/Repository/baerenherz/src/content/news/golf-charity-hope.mdx";
const Content = (props = {}) => MDXContent({
											...props,
											components: { Fragment, ...props.components },
										});
Content[Symbol.for('astro.needsHeadRendering')] = !Boolean(frontmatter.layout);
Content.moduleId = "D:/Bärenherz/Repository/baerenherz/src/content/news/golf-charity-hope.mdx";
